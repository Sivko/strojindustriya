  ...
  return (
    <div className="mt-extra">
      ...
      <div className="md:grid grid-cols-4 gap-4 pb-6  content mt-12 md:mt-24 items-center">
        ...
        <div className="col-span-3 border-b border-outline">
          <div className="md:grid gap-4 grid-cols-3 items-center">
            <div className="text-[96px] col-span-2 font-light">Брифинг</div>
        ...
        <div className="col-span-3 border-b border-outline">
          <div className="md:grid gap-4 grid-cols-3 items-center">
            <div className="text-[96px] col-span-2 font-light">Договор</div>
            <div className="text-addText text-base">
              <ul>
                <li>Тема проекта</li>
                <li>Потребности, предпочтения, ожидания клиента</li>
        ...
        <div className="col-span-3 border-b border-outline">
          <div className="md:grid gap-4 grid-cols-3 items-center">
            <div className="text-[96px] col-span-2 font-light">Реализация</div>
            <div className="text-addText text-base">
              <ul>
                <li>Тема проекта</li>
                <li>Потребности, предпочтения, ожидания клиента</li>
        ...
        <div className="col-span-3 border-b border-outline">
          <div className="md:grid gap-4 grid-cols-3 items-center">
            <div className="text-[96px] col-span-2 font-light">Сдача работ</div>
            <div className="text-addText text-base">
              <ul>
                <li>Тема проекта</li>
                <li>Потребности, предпочтения, ожидания клиента</li>
