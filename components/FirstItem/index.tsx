...
export default function FirstItem() {
  return (<div>
    ...
    <Image className=" mt-14 w-full" src="/images/main.png" height={852} width={1600} alt="" blurDataURL="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mPc8R8AAnUBuTe7lTwAAAAASUVORK5CYII=" />
  </div>)
}