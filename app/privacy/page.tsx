...
export default async function Page(request: Params) {
  ...
  return (
    <>
      <div className="container max-w-[800px] mt-12">
        <div className="">
          ...
          <div className="row mb-4">
            <div className="col">
              <h5 className="mb-4 font-bold">1. Общие положения</h5>
              <div className="descr">
                ...
                данных, предпринимаемые <span className="link mark owner-name-field" id="owner-name-value">ООО Стройиндустрия-К</span> (далее&nbsp;— Оператор).
              </div>
              <div className="ol">
                <div className="mb-2">
                ...
                <div className="mb-2">
                  ...
                  которую Оператор может получить о&nbsp;посетителях веб-сайта <span className="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">https://strojindustriya-k.ru</span>.
                </div>
              </div>
            </div>
          </div>
          <div className="row mb-4">
            <div className="col">
              <h5 className="mb-4 font-bold">2. Основные понятия, используемые в&nbsp;Политике</h5>
              <div className="ol">
                <div className="mb-2">
                ...
                <div className="mb-2">
                  ...
                  их&nbsp;доступность в&nbsp;сети интернет по&nbsp;сетевому адресу <span className="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">https://strojindustriya-k.ru</span>.
                </div>
                <div className="mb-2">
                ...
                <div className="mb-2">2.8. Персональные данные&nbsp;— любая информация,
                  относящаяся прямо или косвенно к&nbsp;определенному или определяемому
                  Пользователю веб-сайта <span className="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">https://strojindustriya-k.ru</span>.
                </div>
                <div className="mb-2">
                ...
                <div className="mb-2">
                  2.10. Пользователь&nbsp;— любой посетитель веб-сайта <span className="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">https://strojindustriya-k.ru</span>.
                </div>
                <div className="mb-2">
          ...
          <div className="row mb-4">
            <div className="col">
              <h5 className="mb-4 font-bold">3. Основные права и&nbsp;обязанности Оператора</h5>
              <div className="ol">
                <div className="mb-2">3.1. Оператор имеет право:</div>
                <div className="mb-2">
                ...
                <div className="mb-2">3.2. Оператор обязан:</div>
                <div className="mb-2">
          ...
          <div className="row mb-4">
            <div className="col">
              <h5 className="mb-4 font-bold">4. Основные права и&nbsp;обязанности субъектов персональных данных</h5>
              <div className="ol">
                <div className="mb-2">4.1. Субъекты персональных данных имеют право:</div>
                <div className="mb-2">
                ...
                <div className="mb-2">4.2. Субъекты персональных данных обязаны:</div>
                <div className="mb-2">
          ...
          <div className="row mb-4">
            <div className="col">
              <h5 className="mb-4 font-bold">5. Принципы обработки персональных данных</h5>
              <div className="ol">
                <div className="mb-2">
          ...
          <div className="row mb-4">
            <div className="col">
              <h5 className="mb-4 font-bold">6. Цели обработки персональных данных</h5>
              <div className="ol">
                <div className="mb-12" id="QFsDioRuY">
                  <table >
                    <tbody><tr>
                      <th className="text-left">Цель обработки</th>
                      <td className="purpose-field"><span className="mark link">информирование Пользователя посредством отправки электронных писем</span></td>
                    </tr>
                      <tr>
                        <th className="text-left">Персональные данные</th>
                        <td className="data-field"><span className="mark link">Имя, Email и номер телефона</span></td>
                      </tr>
                      <tr>
                        <th className="text-left">Правовые основания</th>
                        <td className="legal-field"><span className="mark link">Федеральный закон «Об&nbsp;информации, информационных технологиях и&nbsp;о&nbsp;защите информации» от&nbsp;27.07.2006&nbsp;N 149-ФЗ</span></td>
                      </tr>
                      <tr>
                        <th className="text-left">Виды обработки персональных данных</th>
                        <td className="types-field"><span className="mark link">Передача персональных данных</span></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
          ...
          <div className="row mb-4">
            <div className="col">
              <h5 className="mb-4 font-bold">7. Условия обработки персональных данных</h5>
              <div className="ol">
                <div className="mb-2">
            ...
            <div className="col">
              ...
              <div className="ol">
                ...
                <div className="mb-2">
                  ...
                  Оператору уведомление на&nbsp;адрес электронной почты Оператора <span className="link mark owner-email-field" data-scroll-to="#owner-email-field">strojindustriya-k@yandex.ru</span>
                ...
                <div className="mb-2">
                  ...
                  посредством электронной почты на&nbsp;электронный адрес Оператора <span className="link mark owner-email-field" data-scroll-to="#owner-email-field">strojindustriya-k@yandex.ru</span>
          ...
          <div className="row mb-4">
            <div className="col">
              <h5 className="mb-4 font-bold">10. Трансграничная передача персональных данных</h5>
              <div className="ol">
                <div className="mb-2">
          ...
          <div className="row mb-4">
            <div className="col">
              <h5 className="mb-4 font-bold">11. Конфиденциальность персональных данных</h5>
              <div className="descr">
          ...
          <div className="row mb-4">
            <div className="col">
              <h5 className="mb-4 font-bold">12. Заключительные положения</h5>
              <div className="ol">
                <div className="mb-2">
                  ...
                  к&nbsp;Оператору с&nbsp;помощью электронной почты <span className="link mark owner-email-field" data-scroll-to="#owner-email-field">strojindustriya-k@yandex.ru</span>.
                </div>
                <div className="mb-2">
                ...
                <div className="mb-2">
                  ...
                  в&nbsp;сети Интернет по&nbsp;адресу <span id="owner-privacy-url-value" className="link mark owner-privacy-url-field" data-scroll-to="#owner-privacy-url-field">https://strojindustriya-k.ru/privacy/</span>.
                </div>
              </div>
            </div>
          </div>
